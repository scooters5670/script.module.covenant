...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32019, 'movies&url=q%3DimdbList%26listType%3Dviews', 'most-voted.png', 'DefaultMovies.png')
    ...
    def mymovies(self, lite=False):
        ...
        if traktCredentials == True and imdbCredentials == True:
            ...
            self.addDirectoryItem(32032, 'movies&url=imdbUserWatchlist', 'imdb.png', 'DefaultMovies.png', queue=True)
            self.addDirectoryItem(32033, 'movies&url=imdbUserWatchlist2', 'imdb.png', 'DefaultMovies.png', queue=True)
